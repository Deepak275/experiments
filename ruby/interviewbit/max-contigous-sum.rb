...
for i in 1..(a.length - 1) do
  max_current = [max_current, max_current + a[i]].max

  # max_global = [max_global, max_current + a[i]].max
...
#   max_current = [a[i], max_current + a[i]].max
